...
public class reStock extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, -1, 20));
        ...
        jPanel5.add(price, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 320, 230, 30));

        jLabel11.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(102, 0, 102));
        jLabel11.setText("Date:");
        jPanel5.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, -1, 20));

        jLabel9.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(51, 0, 51));
        jLabel9.setText("Restock");
        jPanel5.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 40, -1, -1));

        jPanel2.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, 560, 420));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 60, 670, 450));
        ...
        jPanel3.add(refresh);
        refresh.setBounds(0, 260, 220, 30);
        ...
        add.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 0, -1, 30));

        jPanel3.add(add);
        add.setBounds(0, 60, 220, 30);
        ...
        jLabel17.setText("UPDATE STOCKS");
        ...
        update.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(54, 0, -1, 30));

        jPanel3.add(update);
        update.setBounds(0, 110, 220, 30);
        ...
        jLabel18.setText("DELETE STOCKS");
        ...
        delete.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 0, 120, 30));

        jPanel3.add(delete);
        delete.setBounds(0, 160, 220, 30);
        ...
        back.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 0, 50, 30));

        jPanel3.add(back);
        back.setBounds(0, 210, 220, 30);

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 220, 450));
        ...
        jPanel10.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 10, -1, 40));
    ...
    if (i_id.getText().trim().isEmpty() || quan.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Item ID and Quantity are required!");
    } else {
        try {
            connectDB conn = new connectDB();

            int itemId = Integer.parseInt(i_id.getText().trim());
            int qtyAmount = Integer.parseInt(quan.getText().trim());
            String newPriceText = price.getText().trim();  // Price input field

            // Check if the item exists in inventory
            String checkStockSQL = "SELECT quantity, price FROM items WHERE i_id = ?";
            ...
            int rowsUpdated = conn.updateData(updateStockSQL, qtyAmount, itemId);

            if (rowsUpdated > 0) {
                JOptionPane.showMessageDialog(null, "Stock successfully restocked!");

                // Optionally update price if provided
                if (!newPriceText.isEmpty()) {
                    try {
                        double newPrice = Double.parseDouble(newPriceText);
                        String updatePriceSQL = "UPDATE items SET price = ? WHERE i_id = ?";
                        int priceUpdated = conn.updateData(updatePriceSQL, newPrice, itemId);

                        if (priceUpdated > 0) {
                            JOptionPane.showMessageDialog(null, "Price updated successfully.");
                        } else {
                            JOptionPane.showMessageDialog(null, "Failed to update the price.");
                        }
                ...
                JOptionPane.showMessageDialog(null, "Failed to restock the item.");
            }
